...
class RecordCtrl:
    ...
    def record(self):
        ...
        record_button = self.parent.get_record_button()
        ...
        record_button.SetBitmap(wx.Bitmap(os.path.join(self.path, "img", "video.png"),
                                          wx.BITMAP_TYPE_ANY))
        self.parent.Refresh()
        self.parent.Update()
        ...
        while count > 0 or infinite:
            ...
            if settings.CONFIG.getboolean('DEFAULT', 'Force Quit') or (
                ...
                dlg = wx.MessageDialog(
                    None, "Stopped", "The playback loop is end", wx.OK | wx.ICON_WARNING)
                dlg.ShowModal()
...
class RecordSaver:
    ...
    def save_file(self, event):
        ...
        with wx.FileDialog(self.parent, "Save recording file", wildcard="*", defaultFile="capture.txt",
